...
fn main() -> ! {
    ...
    let spi_sclk = pins.sclk.into_function::<gpio::FunctionSpi>();
    let spi_mosi = pins.mosi.into_function::<gpio::FunctionSpi>();
    let spi_miso = pins.miso.into_function::<gpio::FunctionSpi>();
    let spi_cs = pins.d9.into_push_pull_output();
